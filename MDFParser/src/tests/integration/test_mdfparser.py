...
class TestMain:
    ...
    def boto3_mock(self, mocker: MockerFixture):
        ...
        return mocker.patch('s3_interaction.boto3')
    ...
    def container_services_mock(self, mocker: MockerFixture, boto3_mock: Mock) -> Mock:
        ...
        mocker.patch('downloader.ContainerServices', container_services_mock)
        mocker.patch('uploader.ContainerServices', container_services_mock)
