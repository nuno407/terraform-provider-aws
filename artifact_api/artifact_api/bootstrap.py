...
def bootstrap():
    ...
    di["config_path"] = os.getenv("ARTIFACT_API_CONFIG_PATH", "/app/config/config.yml")
    di["tenant_config_path"] = os.getenv("TENANT_MAPPING_CONFIG_PATH", "/app/tenant-mapping-conf/tenant-mapping-conf.yml")
