...
class VoxelVideo(VoxelSample):  # pylint: disable=too-few-public-methods
    ...
    class Fields(Enum):
        ...
        HOUR = VoxelField(field_name="hour", field_type=fo.core.fields.IntField)
        DAY = VoxelField(field_name="day", field_type=fo.core.fields.IntField)
        MONTH = VoxelField(field_name="month", field_type=fo.core.fields.IntField)
        YEAR = VoxelField(field_name="year", field_type=fo.core.fields.IntField)
        RECORDING_DURATION = VoxelField(field_name="recording_duration", field_type=fo.core.fields.FloatField)
        RESOLUTION = VoxelField(field_name="resolution", field_type=fo.core.fields.StringField)
        ...
        NUM_SNAPSHOTS = VoxelField(field_name="num_snapshots", field_type=fo.core.fields.IntField)
        RULES = VoxelField(
            field_name="rules",
            field_type=fo.core.fields.ListField,
    ...
    def attach_rule_to_video(cls, dataset: fo.Dataset, rule: VideoUploadRule) -> None:
        ...
        values_to_set: dict[VoxelField, Any] = {
            cls.Fields.RULES.value: VoxelSample._append_to_list("rules", [fo.DynamicEmbeddedDocument(**db_rule.dict())])
        }
        cls._upsert_sample(
