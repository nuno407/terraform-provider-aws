...
from base.model.artifacts import (KinesisVideoArtifact, RecorderType,
...
class TestVideoIngestor():
    ...
    @fixture()
    def video_artifact(self) -> KinesisVideoArtifact:
        """KinesisVideoArtifact for testing."""
        return KinesisVideoArtifact(
            tenant_id=TENANT_ID,
            device_id=DEVICE_ID,
    ...
    @mark.unit()
    def test_non_video_raises_exception(self, video_ingestor: KinesisVideoIngestor,
    ...
    @mark.unit()
    def test_existing_video_is_discarded(self, s3_controller: S3Controller, video_ingestor: KinesisVideoIngestor,
                                         video_artifact: KinesisVideoArtifact) -> None:
    ...
    def test_successful_ingestion(
            self,
            container_services: ContainerServices,
            video_ingestor: KinesisVideoIngestor,
            s3_controller: S3Controller,
