...
import pytest
import json
from message import VideoMessage, SnapshotMessage, Chunk
from ingestor import MetadataIngestor as MI
import gzip
...
def container_services() -> Mock:
    ...
    cs.get_kinesis_clip = Mock(return_value = b"These are some video bytes")
    cs.sqs_queues_list = {
...
def metadata_full() -> dict:
    with open(f"artifacts/datanauts_DATANAUTS_DEV_01_InteriorRecorder_1657297040802_1657297074110_metadata_full.json","r") as f:
        mdf = json.load(f)
    return mdf
...
def metadata_chunks(metadata_files) -> dict[int,dict]:
    ...
    for file in metadata_files:
        with open(f"artifacts/metadata_raw_chunks/{file}","rb") as f:
...
def msg_snapshot() -> SnapshotMessage:
    ...
    chunks = [
        {"uuid":"TrainingMultiSnapshot_TrainingMultiSnapshot-552001f5-0d63-461e-9c4c-0ef3d74995e5_5.jpeg","upload_status":"UPLOAD_STATUS__SELECTED_FOR_UPLOAD","start_timestamp_ms":1657642653000,"end_timestamp_ms":1657642654000,"payload_size":422576},
        {"uuid":"TrainingMultiSnapshot_TrainingMultiSnapshot-552001f5-0d63-461e-9c4c-0ef3d74995e5_6.jpeg","upload_status":"UPLOAD_STATUS__SELECTED_FOR_UPLOAD","start_timestamp_ms":1657642655000,"end_timestamp_ms":1657642656000,"payload_size":455856}
    ]
