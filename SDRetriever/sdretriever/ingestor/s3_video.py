...
from base.aws.s3 import S3ControllerFactory, S3Controller
...
class S3VideoIngestor(Ingestor):
    ...
    def __init__(self,
                 rcc_s3_client_factory: S3ControllerFactory,
                 post_processor: IVideoPostProcessor,
                 s3_io: S3DownloaderUploader):
        self._post_processor = post_processor
        self.__s3_io = s3_io
        self.__rcc_s3_controller = rcc_s3_client_factory
    ...
    def __get_video_s3(self, artifact: S3VideoArtifact) -> bytes:
        ...
        try:
            video_bytes = self.__rcc_s3_controller().download_file(bucket, key)
