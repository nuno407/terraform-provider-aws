...
DB_CONNECTION_ENABLED   = False                 # states if container has connection to DB (DB_CONNECTION_ENABLED = True) or not (DB_CONNECTION_ENABLED = False). Only true for metadata container
