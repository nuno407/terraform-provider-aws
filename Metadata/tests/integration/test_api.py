...
class TestApi:
    ...
    @pytest.mark.parametrize("video_url,s3_bucket_name,s3_key",
                             [("/getAnonymizedVideoUrl/srxdriverpr1external07_rc_srx_qa_driverpr1_007_InteriorRecorder_1645517710980_1645519350202",
                               "qa-rcd-anonymized-video-files",
                               "Debug_Lync/srxdriverpr1external07_rc_srx_qa_driverpr1_007_InteriorRecorder_1645517710980_1645519350202_anonymized.mp4"),
                              ])
