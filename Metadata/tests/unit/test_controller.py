...
@pytest.mark.unit
def test_get_video_signals_200(mock_flask_client):
    test_client = mock_flask_client[0]
...
@pytest.mark.unit
def test_get_video_signals_400(mock_flask_client):
    test_client = mock_flask_client[0]
    service = mock_flask_client[1]
...
@pytest.mark.unit
def test_get_video_signals_500(mock_flask_client):
    test_client = mock_flask_client[0]
    service = mock_flask_client[1]
...
@pytest.mark.unit
def test_update_video_description_200(mock_flask_client):
    test_client = mock_flask_client[0]
    service = mock_flask_client[1]
...
@pytest.mark.unit
def test_update_video_description_400(mock_flask_client):
    test_client = mock_flask_client[0]
    service = mock_flask_client[1]
...
@pytest.mark.unit
def test_update_video_description_500(mock_flask_client):
    test_client = mock_flask_client[0]
    service = mock_flask_client[1]
...
@pytest.mark.unit
def test_get_table_data_200(mock_flask_client):
    test_client = mock_flask_client[0]
    service = mock_flask_client[1]
...
@pytest.mark.unit
def test_get_table_data_400(mock_flask_client):
    test_client = mock_flask_client[0]
    service = mock_flask_client[1]
...
@pytest.mark.unit
def test_get_table_data_500(mock_flask_client):
    test_client = mock_flask_client[0]
    service = mock_flask_client[1]
...
@pytest.mark.unit
def test_get_single_table_data_200(mock_flask_client):
    test_client = mock_flask_client[0]
    service = mock_flask_client[1]
...
@pytest.mark.unit
def test_get_single_table_data_400(mock_flask_client):
    test_client = mock_flask_client[0]
    service = mock_flask_client[1]
...
@pytest.mark.unit
def test_get_single_table_data_500(mock_flask_client):
    test_client = mock_flask_client[0]
    service = mock_flask_client[1]
...
@pytest.mark.unit
def test_get_anonymized_video_url_200(mock_flask_client):
    test_client = mock_flask_client[0]
    service = mock_flask_client[1]
...
@pytest.mark.unit
def test_get_anonymized_video_url_400(mock_flask_client):
    test_client = mock_flask_client[0]
    service = mock_flask_client[1]
...
@pytest.mark.unit
def test_get_anonymized_video_url_500(mock_flask_client):
    test_client = mock_flask_client[0]
    service = mock_flask_client[1]
