...
def processing_anonymize(client, container_services, body):
    ...
    executes the anonymization algorithm (WIP) for the file received and updates 
    the relevant info in its relay list
    ...
    Returns:
        relay_data {dict} -- [dict with the updated info for the file received and 
                              to be sent via message to the input queues of the 
                              relevant containers]
    """  
