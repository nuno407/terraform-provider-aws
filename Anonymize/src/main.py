...
def main():
    ...
    while(True):
        ...
        if message:
            ...
            # Processing step
            relay_list = processing_anonymize(message['Body'])
    ...
    '''
    # Get file from S3 bucket to be processed
    Bucket_test="dev-rcd-raw-video-files"
    Key_test= "lync/test_containers.png"

    object_test = container_services.get_file(s3_client, Bucket_test, Key_test)
    '''
